...
def connect_treeview_to_detector(treeview, scrolling_detector):
    """
    treeview -- Gtk.TreeView: a TreeView with CellRendererIcons already added.

    scrolling_detector -- ScrollingDetector: attached to the Gtk.ScrolledWindow
